import type {CueAndLoop, Track as OneLibraryTrack} from 'onelibrary-connect';
 ...
 */
export type Track<
  withFKs extends import('onelibrary-connect').EntityFK =
    import('onelibrary-connect').EntityFK.WithRelations,
